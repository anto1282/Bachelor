...
if [ $1 == "-r" ];
then
    srun nextflow run NPhAnToM.nf --IDS ERR575692	 -profile cluster -resume -with-mpi -with-tower --accessToken eyJ0aWQiOiA3MTg5fS4yNmQwY2Q5N2RjZDdlNWI4NWVkNDE4MTUwYjZjNTk5ODQ3OGMxZDcx 
else
